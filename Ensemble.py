...
# 
# This exercise plots the decision surfaces of forests of randomized trees trained on pairs of
...
# Import packages and load the iris data.
...
# Compute and plot the decision boundaries for each type.
